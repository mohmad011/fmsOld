...
const ChartCom = ({ SelectedLocations, chartModal, setchartModal }) => {
  ...
  return (
    <>
      <div className='menu_bottom_main d-flex position-absolute'>
        <div
          className={`position-fixed AddGeofence ${ chartModal ? 'show' : 'hide'} trans`}
        >
          <div style={{background:darkMode ? "rgb(21 25 37)" : "white"}}>
            <div className="d-flex justify-content-center justify-content-md-between flex-wrap">
              <div className="d-flex justify-content-between align-items-center px-3 mb-4 w-100">
                <div className="text-danger">Video player</div>
                <Button
