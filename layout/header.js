...
import { darkMode, userConfigImg }  from "../lib/slices/config";
  ...
  return (
	...
	S335.983,111.18,256,111.18z"
                  ...
                  {otherLocales?.map((locale) => {
                    ...
                    return (
                      <Dropdown.Item
                        ...
                        onClick = {()=>{
                        setTimeout(() => {
                          router.pathname.includes("track","history") && router.reload()
                        }, 1000)
                        }}
                        >
                        <Image
              ...
              <Dropdown as="li" className="nav-item">
                ...
                >
                  {/* <Image
                    loader={() => imageUrl ? imageUrl : "/assets/images/avatars/01.png"}
                    src={getAvater(imageUrl)}
                    width={40}
                    height={40}
                    alt="User-Profile"
